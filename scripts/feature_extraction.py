...
def analyze_audio(audio_path: str) -> np.ndarray:
    ...
    return np.concatenate(
        [
            ...
            np.mean(chroma_cens, axis=1),  # Chroma CENS feature
            np.mean(chroma_cqt, axis=1),  # Chroma CQT feature
            np.mean(chroma_stft, axis=1),  # Chroma STFT feature
            ...
            tonnetz,  # Tonnetz features (tonal content)
        ],
    )
...
"""
[[0.31396484 0.34326172 0.35546875 ... 0.61572266 0.64501953 0.51220703]] 

[[19101.5625  6070.3125  6843.75   ... 19078.125  19429.6875 19546.875 ]] 

[[0.06047339 0.00093177 0.00024489 ... 0.02621692 0.00874047 0.00761637]] 

[[10.84041794 11.07663533  9.84344181 ...  7.21280546  9.01777068
  16.03950601]
...
[[6234.0474763  2849.64145195 3091.66463953 ... 4797.78216005
  3983.00240703 3890.47803846]] 

[[13610.2420194   3228.6687767   3442.34960675 ... 15558.11550192
  16703.24567431 17015.07517292]] 

-1.0534518 

[[ 0.00174913  0.00226172  0.00294021 ... -0.01652969 -0.01897287
  -0.01091438]
